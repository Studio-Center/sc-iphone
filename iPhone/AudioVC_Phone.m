...
@synthesize kidsButton, top10MenButton, top10WomanButton, ForeignButton, mixOfTheWeekButton;
...
-(void)viewDidLoad {
	...
	[[dataSources objectAtIndex:0] setMethodName:@"getKids"];
	[[dataSources objectAtIndex:1] setMethodName:@"top10Man"];
	[[dataSources objectAtIndex:2] setMethodName:@"top10Woman"];
	[[dataSources objectAtIndex:3] setMethodName:@"getForeignAudio"];
	[[dataSources objectAtIndex:4] setMethodName:@"getMixOFWeek"];
