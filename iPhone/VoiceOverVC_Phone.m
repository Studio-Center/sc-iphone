...
#import "VoiceOverVC_Phone.h"
#import "Video.h"
#import "SOAPLoader.h"
#import "PhoneNavigator.h"

@implementation VoiceOverVC_Phone
@synthesize items;
...
- (IBAction)buttonNavClick:(NSInteger)aTag {
	...
	NSString *oldView = [[NSString alloc] init];
		
	switch (aTag) {
		case 1:
			selView = @"VoiceOverVC_Audio";
			break;
		case 2:
			selView = @"VoiceOverVC_Audio";
			break;
...
- (void)viewDidLoad {
	...
	[methods addObject:@"getAudioPost"];
	//[methods addObject:@"getMixOfWeek"];
	//[methods addObject:@"getOnHold"];
